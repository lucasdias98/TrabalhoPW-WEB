...
public class DAOGenerico<TIPO>implements Serializable {
    ...
    public List<TIPO> getListaObjetos() {
        ...
        if(filtro.length() > 0){
            switch(ordemAtual.getOperador()){
                case "=":
                    // tratar se o ID para ser um numero
    ...
    //é importante validar a exibição do numero existentes no final da lista. por exemplo
    // de 10 em 10, supondo que existam 47 registros. na pagina 5, deve-se exibir somente 7 registros.
    public void ultimo(){
    ...
    //encapsuled fields da segunda etapa
